...
public class RubberDucky extends Block implements BlockEntityProvider {

    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public static final VoxelShape SHAPE = Block.createCuboidShape(3.5, 0, 3.5, 12.5, 7, 12.5);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new RubberDuckyEntity(pos, state);
    }
}
